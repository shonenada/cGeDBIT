...
vector<int> CIncrementalSelection::selectPivots(CMetric *metric, vector<shared_ptr<CIndexObject> > &data, int numPivots)
{
	return selectPivots(metric, data, 0, data.size(), numPivots);
}
vector<int> CIncrementalSelection::selectPivots(CMetric *metric, vector<shared_ptr<CIndexObject> > &data, int first, int size, int numPivots)
{
 ...
 */
vector<int> CIncrementalSelection::removeDuplicate(CMetric *metric, vector<shared_ptr<CIndexObject> > &data,vector<int> pivots)
{
