...
*/
CIndexNode::CIndexNode(vector<shared_ptr<CIndexObject> > pivots,int height)
{
	this->pivots=pivots;
	this->height=height;
...
*/
shared_ptr<CIndexObject>  CIndexNode::getPivot(int pivotIndex)
{
...
*/
vector<shared_ptr<CIndexObject> >& CIndexNode::getPivots()
{
    return pivots;
}
