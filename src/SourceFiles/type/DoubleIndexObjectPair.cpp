...
*/
CDoubleIndexObjectPair::CDoubleIndexObjectPair(double d,shared_ptr<CIndexObject> obj)
{
	dist = d;
	object=obj;
}
...
*/
shared_ptr<CIndexObject> CDoubleIndexObjectPair::getObject()
{
	return object;
}
...
void CDoubleIndexObjectPair::setObject(shared_ptr<CIndexObject> obj)
{
	object=obj;
}
