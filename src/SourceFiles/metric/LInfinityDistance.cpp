#define CHECKPOINTER
#include "../../HeaderFiles/metric/LInfinityDistance.h"
...
/** compute the distance of two objects of class CIndexObject, or its subclass. 
 ...
 */
double CLInfinityDistance::getDistance(CIndexObject *_obj1,CIndexObject *_obj2)
{
#ifdef CHECKPOINTER
