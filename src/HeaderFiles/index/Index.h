...
public:
	...
	*/
	virtual void bulkLoad(vector<shared_ptr<CIndexObject> > &objectList,int runMode)=0;
	...
	*/
	virtual vector<shared_ptr<CIndexObject> >* search(CQuery* q)=0;
	...
	*/
	virtual vector<shared_ptr<CIndexObject> > getAllDataPoints()=0;
