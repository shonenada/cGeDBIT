...
public:
	...
	*/
	CMVPInternalNode(vector<shared_ptr<CIndexObject> > pivots,vector<vector<double>> lower,vector<vector<double>> upper,vector<shared_ptr<CIndexNode> > child,int myHeight);
