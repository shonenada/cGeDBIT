 ...
 *  - The method getDistance(CIndexObject*, CIndexObject*) will return the distance of the two objects of CIndexObject.
...
public:
	...
	/** 
	 * @brief The method will return the distance of the two objects of CIndexObject.
	 */
