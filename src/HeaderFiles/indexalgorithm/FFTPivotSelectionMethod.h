...
public:
	...
	*/
	vector<int> selectPivots(CMetric *metric,vector<shared_ptr<CIndexObject> > &data,int numPivots);
    ...
    /*
		...
		@return return a container consists of the indexes of the selected pivots in the given data set 
	*/
	vector<int> selectPivots(CMetric *metric,vector<shared_ptr<CIndexObject> > &data,int first,int dataSize,int numPivots);
	...
	/*
		...
		@return return a container consists of the indexes of the selected pivots in the given data set 
	*/
	vector<int> selectPivots(CMetric *metric,vector<shared_ptr<CIndexObject> > &data,int first,int dataSize,int numPivots,int firstPivot);
