...
public:
	...
	vector<int> selectPivots(CMetric *metric, vector<shared_ptr<CIndexObject> > &data, int first, int size, int numPivots);
      ...
      */
	static vector<int> removeDuplicate(CMetric *metric, vector<shared_ptr<CIndexObject> > &data, vector<int> pivots);
