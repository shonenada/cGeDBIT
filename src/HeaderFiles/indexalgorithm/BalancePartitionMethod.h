...
public:
     ...
     */
    virtual CPartitionResults partition(CMetric *metric, const vector<shared_ptr<CIndexObject> > &pivots,
                                vector<shared_ptr<CIndexObject> > &data, int first, int size,
                                int maxParition, int maxLeafSize);
     ...
     */
	virtual CPartitionResults partition(CMetric *metric, const vector<shared_ptr<CIndexObject> > &pivots,
                                        vector<shared_ptr<CIndexObject> > &data, int first, int size, double maxRadius,
                                        int maxParition, int maxLeafSize, double middleProportion);
